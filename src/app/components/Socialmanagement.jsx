...
const CARDS = [
  {
    ...
    para: "Plan, queue and publish content across all your social channels from one powerful calendar view.",
  },
  {
    header: "AI Content Assistant",
    para: "Generate captions, hashtags and reply suggestions tailored to your brand voice in seconds.",
  },
  {
    header: "Real-Time Analytics",
    para: "Track engagement, reach and follower growth with dashboards that update as your audience does.",
  },
];
...
// FEATURE CARD
// ═══════════════════════════════════════════════════════════════════
function FeatureCard({ header, para }) {
  return (
    <div style={{
      borderRadius: 32,
      ...
      <div style={{
        ...
        {/* swap with <Image src="/icons/..." width={26.67} height={16} alt="" /> */}
        <CardIcon />
      </div>
      ...
      <div className="page-container">
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{
            ...
            border: "1px solid rgba(0,109,63,0.15)",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              {CARDS.map((c) => <FeatureCard key={c.header} {...c} />)}
            </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {/* <Image src="/images/social-1.png" fill style={{ objectFit: "cover" }} alt="" /> */}
              <div style={{
            ...
            <div style={{
              ...
              {/* <Image src="/images/social-2.png" fill style={{ objectFit: "cover", borderRadius: 40 }} alt="" /> */}
              <div style={{
